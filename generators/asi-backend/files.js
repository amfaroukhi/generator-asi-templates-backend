...
function writeFiles() {
  return {
    ...
    writeServerModulesFiles() {
      this.copy('../../asi-templates-backend-batch', 'asi-templates-backend-batch');
      this.copy('../../asi-templates-backend-business', 'asi-templates-backend-business');
      this.copy('../../asi-templates-backend-common-dependencies', 'asi-templates-backend-common-dependencies');
      this.copy('../../asi-templates-backend-common-dto', 'asi-templates-backend-common-dto');
      this.copy('../../asi-templates-backend-common-serialize', 'asi-templates-backend-common-serialize');
      this.copy('../../asi-templates-backend-config', 'asi-templates-backend-config');
      this.copy('../../asi-templates-backend-dao', 'asi-templates-backend-dao');
      this.copy('../../asi-templates-backend-database-services', 'asi-templates-backend-database-services');
      this.copy('../../asi-templates-backend-dto', 'asi-templates-backend-dto');
      this.copy('../../asi-templates-backend-ged-services', 'asi-templates-backend-ged-services');
      this.copy('../../asi-templates-backend-helpers', 'asi-templates-backend-helpers');
      this.copy('../../asi-templates-backend-mappers', 'asi-templates-backend-mappers');
      this.copy('../../asi-templates-backend-model', 'asi-templates-backend-model');
      this.copy('../../asi-templates-backend-override', 'asi-templates-backend-override');
      this.copy('../../asi-templates-backend-report', 'asi-templates-backend-report');
      this.copy('../../asi-templates-backend-resources', 'asi-templates-backend-resources');
      this.copy('../../asi-templates-backend-serialize', 'asi-templates-backend-serialize');
      this.copy('../../asi-templates-backend-technical-services', 'asi-templates-backend-technical-services');
      this.copy('../../asi-templates-backend-utils', 'asi-templates-backend-utils');
      this.copy('../../asi-templates-backend-validators', 'asi-templates-backend-validators');
      this.copy('../../asi-templates-backend-web-services', 'asi-templates-backend-web-services');
      this.copy('../../asi-templates-backend-webapp', 'asi-templates-backend-webapp');
    },
