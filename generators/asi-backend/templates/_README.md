...
_%>
This application was generated using JHipster <%= asiGenVersion %>, you can find documentation and help at [<%= DOCUMENTATION_ARCHIVE_URL %>](<%= DOCUMENTATION_ARCHIVE_URL %>).
...
[JHipster <%= asiGenVersion %> archive]: <%= DOCUMENTATION_ARCHIVE_URL %>
